...
\033[1;92m=======================================================""")
        ...
        if hoga in ["", " "]:
            ...
            os.system('am start https://www.facebook.com/profile.php?id=100024557781911')
        else:
            Main()
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write(
            "\r\r %s\033[0;93m[SNIGDHO馃う鈥嶁檪锔廬 : \033[0;97m %s/%s -> \033[0;92m [OK馃槏:%s ]- \033[0;93m[CP馃樋:%s ]" % (
